...
console.log(text.replace(/Manuel Marques de Sousa/, 'Walber Araújo'));
...
console.log(text.replace(/(O Centauro de Luvas)/, function(captura, letra){
...
function getMonthNumber(monthName) {
    switch(monthName) {
        ...
        case 'dezembro':
            ...
            break;
        default:
            return 'Informe um mês existente.'
            break;
    }
}
*/
